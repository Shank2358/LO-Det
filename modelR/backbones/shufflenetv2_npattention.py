...
from ..layers.np_attention_blocks import NPAttention,Sobel_Edge_Block
...
class ShuffleNetV2(nn.Module):
    def __init__(self,  model_size='1.5x'):
        ...
        self.__npa = NPAttention(input_channel,input_channel,use_scale=False,groups=8)
...
class ShuffleNet2_Det(nn.Module):
    def __init__(self, extract_list, weight_path=None, model_size='1.5x'):
...
if __name__ == "__main__":
    ...
    net = ShuffleNet2_Det(extract_list=["3", "11", "conv_last"], model_size='0.5x')
    stat(net, (3, 544, 544))
