...
class GhostNet(nn.Module):
    def __init__(self, num_classes=1000, width_mult=1.):
        ...
        self.cfgs = [
        # k_kernel_size, t_expansion_size, c_out, SE, stride
        [3,  16,  16, 0, 1],
        [3,  48,  24, 0, 2],
        [3,  72,  24, 0, 1],
        [5,  72,  40, 1, 2],
...
class GhostNet_Det(nn.Module):
    def __init__(self, extract_list, weight_path=None, width_mult=1.):
        super(GhostNet_Det, self).__init__()

        self.__submodule = GhostNet(width_mult=width_mult)
        if weight_path:
            print("*"*40, "\nLoading weight of F : {}".format(weight_path))
            ...
            del pretrained_dict
            print("Loaded weight of GhostNet : {}".format(weight_path))
...
if __name__=='__main__':
    ...
    net = GhostNet_Det(extract_list=["5", "11", "squeeze"],width_mult=1.0)
    stat(net, (3, 544, 544))
    #print(net)
