...
'''
STANDARD_COLORS = ['royalblue','limegreen', 'silver','darkseagreen','red','mediumvioletred','tomato','springgreen','Snow','paleturquoise',
'turquoise', 'crimson','orangered','forestgreen','LightSlateGrey']'''

STANDARD_COLORS = [
'red','orangered','tomato','lightcoral',
'fuchsia','gold','orange','khaki',
...
if __name__ == '__main__':
  ...
  path = "D:/PyProjects/visdotatest/savep/"
  ...
  pathimg = "D:/Datasets/DOTA/test/images/"  # 文件夹目录
  pathimgsave = "D:/PyProjects/visdotatest/vis_res/"  # 文件夹目录

  for file in files:  # 遍历文件夹
    position = path + file  # 构造绝对路径，"\\"，其中一个'\'为转义符
    #print(position)

    positionimg = pathimg + file.replace('txt','png')  # 构造绝对路径，"\\"，其中一个'\'为转义符file
    #print(positionimg)
    positionimgsave = pathimgsave + file.replace('txt', 'png')  # 构造绝对路径，"\\"，其中一个'\'为转义符file
